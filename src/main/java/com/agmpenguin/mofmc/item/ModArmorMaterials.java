...
public enum ModArmorMaterials implements ArmorMaterial {
    RUBY("ruby", 34, new int[]{4, 8, 7, 3}, 8, SoundEvents.ARMOR_EQUIP_DIAMOND,
    ...
    TITANIUM("titanium", 30, new int[]{3, 6, 4, 2}, 6, SoundEvents.ARMOR_EQUIP_IRON,
            1.0F, 1.0F, () -> Ingredient.of(ModItems.TITANIUM_ROD.get())),
    ...
    RAINBOW("rainbow", 27, new int[]{3, 7, 5, 3}, 14, SoundEvents.ARMOR_EQUIP_NETHERITE,
            0.0F, 0.0F, () -> Ingredient.of(ModItems.RAINBOW_GEM.get()));
