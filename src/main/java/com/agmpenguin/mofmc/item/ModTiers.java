...
public class ModTiers {
    ...
    public static final ForgeTier LIGHT_SWORD = createForgeTierTag(2, -1, 6.0f, 2.0f, 14, BlockTags.NEEDS_IRON_TOOL, ModTags.Items.LIGHT_SWORDS);
    ...
    private static ForgeTier createForgeTierTag(int level, int uses, float speed, float attackDamageBonus, int enchantmentValue, TagKey<Block> toolTypeNeeded, TagKey<Item> MaterialTag) {
        return new ForgeTier(level, uses, speed, attackDamageBonus, enchantmentValue, toolTypeNeeded, () -> Ingredient.of(MaterialTag));
    }
